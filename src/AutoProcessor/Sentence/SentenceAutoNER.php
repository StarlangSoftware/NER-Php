 ...
 * */
abstract class SentenceAutoNER extends AutoNER
{
    /**
     ...
     */
    protected abstract function autoDetectPerson(AnnotatedSentence $sentence): void;
     ...
     */
    protected abstract function autoDetectLocation(AnnotatedSentence $sentence): void;
     ...
     */
    protected abstract function autoDetectOrganization(AnnotatedSentence $sentence): void;
     ...
     */
    protected abstract function autoDetectMoney(AnnotatedSentence $sentence): void;

    /**
     * The method should detect TIME named entities. TIME corresponds to time
     * expressions. Example: {\bf Cuma günü} tatil yapacağım.
     * @param AnnotatedSentence $sentence The sentence for which TIME named entities checked.
     */
    protected abstract function autoDetectTime(AnnotatedSentence $sentence): void;
     ...
     * @param AnnotatedSentence $sentence The sentence for which named entities checked.
     */
    public function autoNER(AnnotatedSentence $sentence): void{
        ...
        for ($i = 0; $i < $sentence->wordCount(); $i++) {
            ...
            if ($word instanceof AnnotatedWord && $word->getNamedEntityType() == null){
